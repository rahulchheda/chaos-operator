...
const (
	versionFile   string = "/src/github.com/litmuschaos/chaos-operator/VERSION"
	buildMetaFile string = "/src/github.com/litmuschaos/chaos-operator/BUILDMETA"
...
func NewVersionCollector(program string) *prometheus.GaugeVec {
	buildInfo := prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			Subsystem: program,
			Name:      "version",
			Help:      "A metric with a constant '1' value labeled by commit and version from which chaos-exporter was built.",
		},
